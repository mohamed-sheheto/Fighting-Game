...
let player1 = new Player('Mohamed', 100, 10)
let player2 = new Player('LAZY', 100, 10)
...
document.addEventListener('keydown', function (e) {
    ...
    if (e.key == 'q' && p2.health > 0 && game.isOver == false) {
        ...
        let attackSound = document.getElementById('p1attack')
        attackSound.play()
    }
...
document.addEventListener('keydown', function (e) {
    ...
    if (e.key == 'a' && p2.health > 0 && game.isOver == false && p1.health < 100) {
        p1.heal(p1)
        let healSound = document.getElementById('p1heal')
        healSound.play()
    }
...
document.addEventListener('keydown', function (e) {
    if (e.key == 'p' && p1.health > 0 && game.isOver == false) {
        ...
        let attackSound2 = document.getElementById('p2attack')
        attackSound2.play()
    }
...
document.addEventListener('keydown', function (e) {
    ...
    if (e.key == 'l' && p1.health > 0 && game.isOver == false && p2.health < 100) {
        p2.heal(p2)
        let healSound2 = document.getElementById('p2heal')
        healSound2.play()
    }
